...
bbl <- function()
{
  ...
  iota.m.beta ~ dunif(.001,10^4)
  iota.s.beta ~ dunif(.001,10^4)
  chi.m.beta ~ dunif(.001,10^4)
  chi.s.beta ~ dunif(.001,10^4)
  mu.tau.beta ~ dunif(.001,10^4)
  mu.nu.beta ~ dunif(.001,10^4)
  ...
  p.iota.m[j] ~ dbeta(iota.m.alpha[j],iota.m.beta)T(0,k)
  p.iota.s[j] ~ dbeta(iota.s.alpha[j],iota.s.beta)T(0,k)
  p.chi.m[j] ~ dbeta(chi.m.alpha[j],chi.m.beta)T(k,1)
  p.chi.s[j] ~ dbeta(chi.s.alpha[j],chi.s.beta)T(k,1)
